...
import daiphan.casestudy.dto.business.IContractDto;
...
public interface IContractRepository extends JpaRepository<Contract,Integer> {
    ...
    @Query(value = "select ct.id as contract, c.`name` as customer, f.`name` as facility, em.`name` as employee," +
            ...
            "   and cd.is_delete = 0 and af.is_delete = 0 " +
